...
CREATE TABLE `board`
(
    `board_num`  int         NOT NULL AUTO_INCREMENT COMMENT '게시판 번호',
    `title`      varchar(20) NOT NULL COMMENT '사용자 제목',
    `content`       varchar(100) NOT NULL COMMENT '내용',
    `email`    tinyint(1) NOT NULL DEFAULT '0' COMMENT '이메일',


    PRIMARY KEY (`board_num`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='사용자게시판';